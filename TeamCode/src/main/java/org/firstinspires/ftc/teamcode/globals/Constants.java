...
public class Constants {
    ...
    public static double TRACK_WIDTH = 13.75; // Inches
    public static double WHEEL_BASE = 10.9; // Inches
    public static double MAX_DRIVE_VELOCITY = 7.75 * 100; // Inches/second
    ...
    public static PIDFCoefficients SWERVO_PIDF_COEFFICIENTS = new PIDFCoefficients(0.2, 0, 0, 0.6);
